...
#include "../RgBase/inc/RgAssert.h"

void rgAssertCalled(unsigned long ulLine, const char * const pcFileName) {
	BSP_LED_Init(LED_RED);
	BSP_LED_On(LED_RED);
}

void rgAssertMsgCalled(unsigned long ulLine, char const*const pcFileName, char const*const message) {
	BSP_LED_Init(LED_RED);
	BSP_LED_On(LED_RED);
}
